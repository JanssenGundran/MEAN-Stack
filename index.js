...
var CONNECTION_STRING = "mongodb+srv://gundranjanjan:Xyz12345@cluster0.xbaqm.mongodb.net/";
...
app.post('/api/books/AddBook', multer().none(), async (req, res) => {
    try {
        ...
        await database.collection("books").insertOne({
            ...
            description: req.body.description,  // ✅ Now stored
            price: req.body.price  // ✅ Now stored
        });
